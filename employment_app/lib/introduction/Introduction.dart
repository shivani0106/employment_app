...
class _IntroductionState extends State<Introduction> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        margin: EdgeInsets.only(left:screenWidth(context)*0.1,right:screenWidth(context)*0.1),
        child: 
      Column(
        ...
        children: [
          Container(
            ...
            children: [
            Container(
            child: Text('WELCOME',style: extralargePrimaryColorSemiBold(),),
          ),
          Container(
            margin: EdgeInsets.only(right:screenWidth(context)*0.1),
            child:Text('To Employement Seeking App',style: largeSecondryColorSemiBold(),)
          ),
          ],),),
          Container(
